var WORLDMAP = {
  ...
  update: function (f_year, f_month, t_year, t_month) {
    ...
    for (var country in this.world_data) {
      var obj = {}
      obj['fillKey'] = "q"+Math.ceil(this.colorScale(this.world_data[country]));
  ...
  //(function(){
    ...
    var margin1 = {top: 200, bottom: 120, left:40, right: 40};
    var width = 800 - margin1.left - margin1.right;
    var height = 670 - margin1.top - margin1.bottom;
    ...
    var svg = d3.select("#chart").append("svg")
                .attr("width", "100%")
                .attr("height", "100%")
                .attr("viewBox", "0 0 " + (width+margin1.left+margin1.right)+ " "+ (height+margin1.top+margin1.bottom))
                .attr("class", "base-svg");
    ...
    //d3.json(url, function(data) {
        ...
        d3.select(".base-svg").append("text")
            .attr("x", margin1.left)
            .attr("y", (margin1.top)/3*2)
            .attr("text-anchor", "start")
            .text("Countries suffering from most attacks")
            .attr("class", "title")
            .attr("style", "font-size:40px;padding-top:20px");
...
//})();
  ...
  init: function () {
    ...
    this.colorScale = d3.scale.log()
                        ...
                        .nice();
                        for(var i = 0; i < 9; i++)
                        console.log(this.colorScale.invert(i))
